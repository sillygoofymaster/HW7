...
namespace Builder
{
    class Program
    {
        ...
        {
            public override void BuildDough() { pizza.SetDough("Margaritish"); }
            public override void BuildSauce() { pizza.SetSauce("Margaritaesque"); }
            public override void BuildTopping() { pizza.SetTopping("Margaritoid"); }
        }
        /** "Director" */
        class Waiter
        {
